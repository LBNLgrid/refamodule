...
def default_structure_config_ac() -> StructureConfigAC:
    return StructureConfigAC(
        ...
        weather_correction_factor=1.0, # consider moving this param to environment
        rugosity_coefficient=0.82, # consider moving this param to conductor or environment
