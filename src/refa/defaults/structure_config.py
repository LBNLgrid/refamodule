...
def default_structure_config_extended_ac():
    return StructureConfigACmetric(
        distance_a_b_m=4, 
        distance_a_c_m=4,
        distance_b_c_m=4,
...
def default_structure_config_extended_dc():
    return StructureConfigDCmetric(
        distance_pos_neg_poles_m=4,
        structure_height_m=25.0,
    )
...
def default_structure_config_loading():
    return StructureConfigLoading(
        line_angle_deg=30.0,
        material_and_geometry="Steel_Pole",
    )